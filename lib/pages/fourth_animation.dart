    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Row(
          ...
          children: [
            _buildHero(context, 'image/chair-alpha.png', 'Chair'),
            _buildHero(context, 'image/binoculars-alpha.png', 'Binoculars'),
            _buildHero(context, 'image/beachball-alpha.png', 'Beach ball'),
          ],
        ),
      ),
    );
